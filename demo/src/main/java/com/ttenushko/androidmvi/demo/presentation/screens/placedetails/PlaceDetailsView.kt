...
import com.ttenushko.androidmvi.demo.presentation.theme.MediumProgress
import com.ttenushko.androidmvi.demo.presentation.theme.SwipeToRefreshLayout
...
@Composable
fun Content(state: State, onRefresh: () -> Unit) {
    SwipeToRefreshLayout(
        refreshingState = state.isLoading,
        onRefresh = onRefresh,
        refreshIndicator = {
            MediumProgress(
                modifier = Modifier
