...
import com.ttenushko.androidmvi.demo.presentation.screens.home.addplace.mvi.reducer
...
internal class MviViewModelCallback(
    private val mviLogger: MviLogger<Action, State>,
    private val search: String,
    private val searchPlaceUseCase: SearchPlaceUseCase,
    private val savePlaceUseCase: SavePlaceUseCase
) : MviStoreViewModel.Callback<Intention, State, Event> {
